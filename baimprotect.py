...
baim.login(token="Esvx0FqbHusNBlJOfa6f.a2jtIjiEA6OEd8Hqa7J97W.3b2xKXuLALNu2b19eqBMk9SqXhY8xAzd6zuwnL/aESs=")
baim.loginResult()
...
#--------------------------------------------------------
		...
		baim.sendText(msg.to,"Success Add all")
#--------------------------------------------------------
		...
		baim.sendText(msg.to,"Success recover")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		gid = baim.getGroupIdsJoined()
		for i in gid:
		    baim.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n")
		baim.sendText(msg.to,"Success BC BosQ")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                baim.sendText(msg.to,"send contact")
...
#--------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    baim.sendText(msg.to,"===[Blacklist User]===\n"+mc)
